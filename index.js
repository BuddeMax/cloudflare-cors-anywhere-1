const exclude = []; // No specific URLs are blacklisted
const include = [
    '^https://tdgqdydxjnssunb\\.weclapp\\.com/webapp/api/v1/', 
    '^https://weclapp\\.onrender\\.com/',
...
const apiKeys = {
    EZWTLwVEqFnaycMzdhBz: {
        name: 'Test App',
        expired: false,
        expiresAt: new Date('2024-12-31'), // Ensure this date is appropriate
        exclude: [], // No specific blacklisted URLs for this key
        include: [
            '^https://tdgqdydxjnssunb\\.weclapp\\.com/webapp/api/v1/', 
            '^https://weclapp\\.onrender\\.com/',
			'^https://localhost:8080'
